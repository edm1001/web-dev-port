  ...
  <Container>
    <Row className="abt-info">
      <Col lg={6} md={5} sm={12} xs={12}>
        ...
        >
          <div className="about-img px-4 text-center text-md-start">
            <img
              alt="about-pic"
              src={AboutPic}
              className="img-fluid"
        ...
        >
          ...
          <div className="about-msg">
            <p className="p-2" id="abt-msg">
              I am enthusiastic about Web Development, this field combines
              creativity with service that I am passionate towards. With my
              background in retail, freelance work, and coding bootcamp, I've
              honed my ability to collaborate effectively and am committed to
              ongoing learning. I will ensure to positively contribute to your
              company's success.
            </p>
          </div>
